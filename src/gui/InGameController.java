...
public class InGameController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		/**
		 * Setzt die MouseEvents, sodass Karten ausgewählt und das Spielfeld
	...
	/**
	 * Methoden um im Menü auf die verschiedenen Buttons clicken zu können und
	 * zum jeweiligen Screen zurück zu gelangen
	 * 
	 * @author lstrauch
	 */
	...
	/**
	 * Diese Methode definiert auf welchen Teil des Stichblattes die ausgewählte
	 * Karte plaziert wird
	 * 
	 * @author lstrauch
	 */
